...
namespace EF_Lab3_Solution.Migrations
{
    ...
    [Migration("20250521215348_AddFluentAPIonTables")]
    partial class AddFluentAPIonTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EF_Lab3_Solution.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TeacherID = 1,
                            Address = "Assuit",
                            BirthOfDate = new DateTime(2025, 5, 22, 0, 53, 47, 604, DateTimeKind.Local).AddTicks(2087),
                            Code = "MMM",
                            HiringDate = new DateTime(2025, 5, 22, 0, 53, 47, 604, DateTimeKind.Local).AddTicks(2143),
                            Jop = "Teacher",
                            Name = "Maged",
                            NationalID = "340005687997",
                            Note = "ok",
                            Qualification = "IT",
                            QualificationDate = new DateTime(2025, 5, 22, 0, 53, 47, 604, DateTimeKind.Local).AddTicks(2149),
                            SchoolID = 1,
                            phone = "0123456789"
                        });
                });
