...
namespace EF_Lab3_Solution.Migrations
{
    ...
    [Migration("20250521205025_Seeding1")]
            ...
            modelBuilder.Entity("EF_Lab3_Solution.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TeacherID = 1,
                            Address = "Assuit",
                            BirthOfDate = new DateTime(2025, 5, 21, 23, 50, 24, 564, DateTimeKind.Local).AddTicks(44),
                            Code = "MMM",
                            HiringDate = new DateTime(2025, 5, 21, 23, 50, 24, 564, DateTimeKind.Local).AddTicks(100),
                            Jop = "Teacher",
                            Name = "Maged",
                            NationalID = "340005687997",
                            Note = "ok",
                            Qualification = "IT",
                            QualificationDate = new DateTime(2025, 5, 21, 23, 50, 24, 564, DateTimeKind.Local).AddTicks(105),
                            SchoolID = 1,
                            phone = "0123456789"
                        });
                });
